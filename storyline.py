...
class Dialogue():
    ...
    def wormDialogue(self): # pop musicians deserve to have colazookas shoved up their hinies until they submit to the coca cola company
